...
# addons/gmorn_button へ submodule として入れるため、そこに project.godot が
...
mkdir -p "$work_dir/addons/gmorn_button"
cp "$addon_dir"/*.gd "$addon_dir"/plugin.cfg "$work_dir/addons/gmorn_button/"
...
config/name="GMornButton Verify"
